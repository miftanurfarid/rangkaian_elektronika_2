	...
	\begin{multicols}{2}
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item $ v_{out} = \frac{0.5}{1 \text{ mV}} = 0.5 \text{ mV} $
...
\begin{frame}{Active Load}
	\begin{multicols}{2}
		\begin{center}
			\includegraphics[height=0.6\textheight]{gambar/01.diff-amp/01.fig30}
		\end{center}
		\columnbreak
		\begin{itemize}
			\item $ A_v = R_C / 2r'_e $
			...
			\item Karena $ Q_6 $ \textit{pnp} sumber arus, $ Q_2 $ ekivalen $ R_C $ dengan ratusan $ M\Omega $
...
\begin{frame}{Diff Amp Terbeban}
	\begin{multicols}{2}
		\begin{center}
			\includegraphics[height=0.7\textheight]{gambar/01.diff-amp/01.fig31a}
		\end{center}
		\columnbreak
		\begin{itemize}
...
\begin{frame}{Diff Amp Terbeban}
	\begin{figure}
		\centering
		\includegraphics[width=0.7\linewidth]{gambar/01.diff-amp/01.fig31}
...
\begin{frame}{Contoh Soal 13}
	\begin{multicols}{2}
		\begin{center}
			\includegraphics[height=0.7\textheight]{gambar/01.diff-amp/01.fig32}
		\end{center}
		\columnbreak
		\begin{itemize}
			\item Pertanyaan:
...
\begin{frame}{Contoh Soal 13}
	\begin{multicols}{2}
		\begin{center}
			\includegraphics[height=0.4\textheight]{gambar/01.diff-amp/01.fig32b}
		\end{center}
		\columnbreak
		\begin{itemize}
			\item Jawaban:
...
\begin{frame}{Latihan Soal 13}
	\begin{multicols}{2}
		\begin{center}
			\includegraphics[height=0.6\textheight]{gambar/01.diff-amp/01.fig32}
		\end{center}
		\columnbreak
		\begin{itemize}
			\item Pertanyaan:
